...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>Your ZPanel account is active!</title>
    ...
    <body>
        ...
        <div class="content">
            ...
            <p><b>To get started:</b>
                <ol>
                    <li><p>Login to your ZPanel account</p></li>
                    <li><p>Create an FTP account</p></li>
                    <li><p>Replace or delete this file (index.html)</p></li>
                </ol>
            </p>
            <p>Thank you for using ZPanel to manage your hosting!</p>
            <p><b>For more infomation and help using ZPanel please visit:</b> <a href="http://www.zpanelcp.com/" target="_blank">www.zpanelcp.com</a>.</p>
            <p>Kind regards,<br />
